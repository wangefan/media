...
int main(int argc, char *argv[]) {
  ...
  data.audio_convert = gst_element_factory_make("audioconvert", "audioconvert_name");
  data.video_convert = gst_element_factory_make("videoconvert", "videoconvert_name");
  data.audio_resample = gst_element_factory_make("audioresample", "resample");
  data.audio_sink = gst_element_factory_make("autoaudiosink", "auido_sink");
  ...
  if (!data.pipeline || !data.source || !data.audio_convert ||
      !data.video_convert || !data.audio_resample || !data.audio_sink ||
      !data.video_sink) {
  ...
  if (!gst_element_link_many(data.audio_convert, data.audio_resample,
...
static void pad_added_handler(GstElement *src, GstPad *new_pad,
  ...
  GstPad *audio_sink_pad =
      gst_element_get_static_pad(data->audio_convert, "sink");
  GstPad *video_sink_pad =
      gst_element_get_static_pad(data->video_convert, "sink");
